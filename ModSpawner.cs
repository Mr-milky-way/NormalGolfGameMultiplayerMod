...
using Fusion;
using UnityEngine;
using NormalGolfGameMultiplayerMod;
...
public class ModSpawner : MonoBehaviour
{
    ...
    public void LoadAndRegisterPrefab(NetworkRunner runner, string assetName)
    {
        ...
        PlayerPosSender pps = rawPrefab.GetComponent<PlayerPosSender>();
        if (pps == null)
        {
            pps = rawPrefab.AddComponent<PlayerPosSender>();
        }
        ...
        try
        {
            ...
            runner.Spawn(
                ...
                onBeforeSpawned: (runnerInstance, obj) =>
                {
                    ...
                    PlayerPosSender pps = obj.GetComponent<PlayerPosSender>();
                    if (pps == null)
                    {
                        Debug.LogError("[NormalGolfGameMultiplayer] PlayerPosSender component missing on spawned object.");   
                    }
                }
